...
FilterHistorical.prototype.hide = function (lst) {
  const itemsToHide = convertNodeListToArray$1(lst.querySelectorAll('[data-historical-item="true"]'));
...
FilterHistorical.prototype.countVisible = function (lst) {
  const items = convertNodeListToArray$1(lst.querySelectorAll('[data-historical-item]'));
  let count = 0;
